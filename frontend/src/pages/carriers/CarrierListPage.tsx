            ...
            <div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-slate-900">Carriers</h1>
                            <p className="text-slate-500 text-premium-sm">{total} carrier(s)</p>
                        </div>
                    </div>
                            ...
                            <table className="table w-full">
                                ...
                                <tbody>
                                    {carriers.map((carrier) => (
                                        <tr key={carrier.id}>
                                            <td className="font-mono font-semibold text-primary-600">{carrier.code}</td>
                                            <td className="font-medium">{carrier.name}</td>
                                            <td>
                                                <span className={`badge ${carrierTypeColor(carrier.carrier_type)}`}>
                                                    {carrierTypeLabel(carrier.carrier_type)}
                                                </span>
                                            </td>
                                            <td className="text-gray-600">{carrier.contact_phone || '—'}</td>
                                            <td>
                                                <span className={`badge ${carrier.is_active ? 'badge-success' : 'badge-danger'}`}>
